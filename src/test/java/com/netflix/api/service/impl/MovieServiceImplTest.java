...
class MovieServiceImplTest {
    ...
    class getMovies {
        ...
        void findAllMoviesValidTest() {
            ...
            Movie movie1 = new Movie(1, "Movie1", "description", LocalDate.of(2026, Month.JULY, 2), 180, "url1.com");
            Movie movie2 = new Movie(2, "Movie2", "description", LocalDate.of(2026, Month.JULY, 3), 160, "url2.com");

            MovieResponseDto expected1 = new MovieResponseDto(1, "Movie1", "description", LocalDate.of(2026, Month.JULY, 2), 180, "url1.com");
            MovieResponseDto expected2 = new MovieResponseDto(2, "Movie2", "description", LocalDate.of(2026, Month.JULY, 3), 160, "url2.com");
            ...
            Assertions.assertAll(() -> Assertions.assertNotNull(response, "Response list should not be null"),
                    () -> Assertions.assertEquals(2, response.size(), "Response list size should be the same as expected"),
                    () -> Assertions.assertEquals(response.getFirst(), expected1, "First DTO should match expected movie"),
                    () -> Assertions.assertEquals(response.getLast(), expected2, "Last DTO should match expected movie")
            );
        ...
        void findMByIdValidTest() {
            int id = 1;
            Movie movie = new Movie(id, "Movie1", "description", LocalDate.of(2026, Month.JULY, 2), 180, "url1.com");
            MovieResponseDto expected = new MovieResponseDto(id, "Movie1", "description", LocalDate.of(2026, Month.JULY, 2), 180, "url1.com");
            ...
            Assertions.assertAll(() -> Assertions.assertNotNull(response, "Response should not be null"),
                    () -> Assertions.assertEquals(id, response.id(), "Id should be the same as expected"),
                    () -> Assertions.assertEquals("Movie1", response.title(), "Title should be the same as expected"),
                    () -> Assertions.assertEquals("description", response.description(), "Description should be the same as expected"),
                    () -> Assertions.assertEquals(LocalDate.of(2026, Month.JULY, 2), response.releaseDate(), "ReleaseDate should be the same as expected"),
                    () -> Assertions.assertEquals(180, response.duration(), "Duration should be the same as expected"),
                    () -> Assertions.assertEquals("url1.com", response.url(), "Url should be the same as expected"));
