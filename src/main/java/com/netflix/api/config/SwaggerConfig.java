...
public class SwaggerConfig {
  ...
  private static final String ACCEPT_LANGUAGE_REF =
      "#/components/parameters/" + ACCEPT_LANGUAGE_PARAM_KEY;
        ...
        new Parameter()
            ...
            .schema(
                new StringSchema()
                    ...
                    ._enum(
                        java.util.List.of(
                            "fr-FR", "br-FR", "en-US", "es-ES", "de-DE", "it-IT", "ja-JP", "zh-CN",
                            "ru-RU")));
        ...
        .info(
            new Info()
                ...
                .contact(
                    new Contact()
                        .name("Netflix V2")
                        .email("contact@netflixv2.com")
                        .url("https://www.netflixv2.com"))
                .license(
                    new License()
                        .name("Apache 2.0")
